...
class CaffeNeuralLayer(CaffeLayer, layers.NeuralLayer):
...
class CaffeStridingLayer(CaffeLayer, layers.StridingLayer):
...
class CaffeDense(CaffeNeuralLayer, layers.Dense):
    pass

class CaffeConv2D(CaffeNeuralLayer, CaffeStridingLayer, layers.Conv2D):
...
class CaffeDropout(CaffeLayer, layers.Dropout):
    pass

class CaffeFlatten(CaffeLayer, layers.Flatten):
