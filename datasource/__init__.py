...
from dltb.datasource import (Datasource, Labeled, Random, Sectioned,
                             Imagesource, Datafetcher)
from dltb.datasource import DataArray, LabeledArray
from dltb.datasource import DataFile
from dltb.datasource import DataFiles
from dltb.datasource import DataDirectory
from dltb.datasource import Video
from dltb.datasource import DataWebcam

from . import predefined
# we do not really want to import that - we just want the code to be
# executed ...
del predefined
