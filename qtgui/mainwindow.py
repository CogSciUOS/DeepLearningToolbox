...
from qtgui.panels import ActivationsPanel, OcclusionPanel, MaximizationPanel
...
class DeepVisMainWindow(QMainWindow):
    ...
    def initMaximizationPanel(self):
        ...
        '''
        self._maximization = MaximizationPanel(self._model)
        self._controller.addChildController(self._maximization,
                                            self._maximization._controller)
